...
in {
  ...
  services.nfs.server.exports = ''
    ...
    /export/kloenk 6.0.2.0/24(rw,nohide,no_subtree_check) 192.168.178.0/24(ro,hide,all_squash)
    /export/Filme 6.0.2.0/24(rw,nohide,no_subtree_check) 192.168.178.0/24(ro,nohide,no_subtree_check,root_squash,anonuid=1000,anongid=1000)
  '';
